<div id="modal-forgot" class="fixed inset-0 flex items-start justify-end z-50 hidden">
    ...
    <div id="modal-container"
        ...
        <div class="flex flex-col justify-center">
            ...
            <form id="forgot-password-form" action="{{ route('forgotPassword') }}" method="POST">
                @csrf
                ...
                <div id="forgot-error-message" class="hidden mb-4 p-2 bg-red-100 border border-red-400 text-red-700 rounded text-sm"></div>
                <div class="flex justify-end gap-2">
                    <button type="submit" class="px-4 py-2 rounded bg-[var(--color-main)] hover:outline-double outline-orange-700 cursor-pointer text-white">
                        <span id="submit-text">Redefinir</span>
