<div id="modal-forgot" class="fixed inset-0 flex items-start justify-end z-50 hidden">
    ...
    <div id="modal-container"
        ...
        <div id="close-modal" class="flex items-center gap-2 cursor-pointer mb-8">
            <i class="fa-solid fa-arrow-left text-sm text-[var(--color-main)]"></i>
            <p class="text-sm text-[var(--color-main)]">Voltar</p>
        </div>
        <div class="flex flex-col justify-center">
            <h2 class="text-[var(--color-text)] text-lg font-semibold mb-4">Redefinir senha</h2>
            <p class="text-[var(--color-main)] text-sm text-justify font-light mb-10">Informe o endereço de e-mail correspondente a sua conta. Iremos lhe encaminhar as instruções para alterar sua senha.</p>
            <form>
