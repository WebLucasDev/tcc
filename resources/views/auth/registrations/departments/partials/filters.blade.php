    ...
    <div id="statistics-container" class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-[var(--color-background)] border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-[var(--color-text)] opacity-70">Total de Departamentos</p>
                    <p id="total-departments" class="text-2xl font-bold text-[var(--color-text)]">
                        {{ $departments->total() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[var(--color-background)] border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-[var(--color-text)] opacity-70">Com Cargos</p>
                    <p id="with-positions" class="text-2xl font-bold text-[var(--color-text)]">
                        {{ $withPositions }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-[var(--color-background)] border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div class="flex items-center">
                <div class="p-2 bg-gray-100 dark:bg-gray-800 rounded-lg">
                    <i class="fa-solid fa-users text-gray-600 dark:text-gray-400"></i>
                </div>
                <div class="ml-3">
                    <p class="text-sm font-medium text-[var(--color-text)] opacity-70">Com Colaboradores</p>
                    <p id="with-collaborators" class="text-2xl font-bold text-[var(--color-text)]">
                        {{ $withCollaborators }}</p>
                </div>
            </div>
        </div>
